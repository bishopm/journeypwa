<template>
  <div class="q-ma-sm">
    <div v-if="household.id" class="text-center q-mt-md">
      ...
      <q-tabs v-model="tab" dense shrink active-bg-color="secondary" no-pane-border align="left" class="q-mt-md bg-primary text-white" indicator-color="secondary">
      <q-tab key="0" name="tabadd" icon="fas fa-plus-circle"/>

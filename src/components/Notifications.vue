<template>
  <div>
    ...
    <button :disabled="loading" @click="sendNotification" type="button" class="btn btn-success btn-send">
    Send Notification
    </button>

    <!-- Enable/Disable push notifications -->
    <button @click="togglePush" :disabled="pushButtonDisabled || loading" type="button" class="btn btn-primary"    :class="{ 'btn-primary': !isPushEnabled, 'btn-danger': isPushEnabled }">
...
export default {
  ...
  methods: {
    ...
    deleteSubscription (subscription) {
      this.loading = true
      this.$axios.post('/subscriptions/delete', { endpoint: subscription.endpoint })
        .then(() => { this.loading = false })
    },
    /**
